...
> See [`docs/portfolio.md`](docs/portfolio.md) for the **Crystara — Topological Crystallization Engine** portfolio section: 3-system recursive architecture, benchmark wins vs GAT / GCN / GraphSAGE / baseline JEPA on semiconductor / GDELT / SEC EDGAR, 16 interpretable semiconductor modules, runtime routing over typed H₀ / H₁ / H₂ modules, and engineering surface.
